...
if __name__ == "__main__":
    datadir = "../../datasets/vimeo90k/vimeo_septuplet/sequences"
    videos = os.listdir(datadir)
    print(videos)
    for video in videos:
        for seq in os.listdir(os.path.join(datadir,video)):
            generate_mod_LR_bic(4, os.path.join(datadir,video,seq), os.path.join(datadir,'..','generate',video,seq))